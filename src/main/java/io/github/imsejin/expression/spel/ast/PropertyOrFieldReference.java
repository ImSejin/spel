...
import io.github.imsejin.expression.spel.*;
...
public class PropertyOrFieldReference extends SpelNodeImpl {
    ...
    private void writeProperty(
            TypedValue contextObject, EvaluationContext evalContext, String name, Object newValue)
            throws EvaluationException {
    ...
    private List<PropertyAccessor> getPropertyAccessorsToTry(
            Object contextObject, List<PropertyAccessor> propertyAccessors) {
