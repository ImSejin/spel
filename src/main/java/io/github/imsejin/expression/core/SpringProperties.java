...
public final class SpringProperties {
    ...
    static {
        try {
            ...
            throw new RuntimeException("Could not load 'spring.properties' file from local classpath: " + ex);
        }
    }
    ...
    public static String getProperty(String key) {
        ...
        if (value == null) {
            try {
                ...
                throw new RuntimeException("Could not retrieve system property '" + key + "': " + ex);
            }
        }
        return value;
    }
