...
package io.github.imsejin.expression.core.convert;
 ...
 *
 * <p>Used to build a {@link org.springframework.core.convert.TypeDescriptor} from a property location. The built
 * {@code TypeDescriptor} can then be used to convert from/to the property type.
 *
 * @author Keith Donald
 * @author Phillip Webb
 * @see io.github.imsejin.expression.core.convert.TypeDescriptor#TypeDescriptor(Property)
