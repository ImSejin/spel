...
import io.github.imsejin.expression.*;
import io.github.imsejin.expression.core.MethodParameter;
...
import io.github.imsejin.expression.spel.support.ReflectiveMethodResolver;
import io.github.imsejin.expression.spel.support.ReflectivePropertyAccessor;
import io.github.imsejin.expression.spel.support.StandardEvaluationContext;
import io.github.imsejin.expression.spel.support.StandardTypeLocator;
import io.github.imsejin.expression.spel.testresources.le.div.mod.reserved.Reserver;
...
public class SpelReproTests extends AbstractExpressionTests {
    ...
    public void SPR5905_InnerTypeReferences() {
        ...
        expr = new SpelExpressionParser().parseRaw("T(io.github.imsejin.expression.spel.SpelReproTests$Outer$Inner).run()");
        assertThat(expr.getValue(context)).isEqualTo(12);

        expr = new SpelExpressionParser().parseRaw("new io.github.imsejin.expression.spel.SpelReproTests$Outer$Inner().run2()");
    ...
    public void reservedWordProperties_SPR9862() {
        ...
        SpelExpressionParser parser = new SpelExpressionParser();
        SpelExpression expression = parser.parseRaw("T(io.github.imsejin.expression.spel.testresources.le.div.mod.reserved.Reserver).CONST");
        Object value = expression.getValue(context);
        Assertions.assertThat(Reserver.CONST).isEqualTo(value);
    }
    ...
    public void SPR10210() {
        StandardEvaluationContext context = new StandardEvaluationContext();
        context.setVariable("bridgeExample", new io.github.imsejin.expression.spel.spr10210.D());
    ...
    public void SPR9495() {
        ...
        context.addMethodResolver((context12, targetObject, name, argumentTypes) -> (context1, target, arguments) -> {
            try {
    ...
    public void SPR11609() {
        ...
        Expression exp = new SpelExpressionParser().parseExpression(
                "T(io.github.imsejin.expression.spel.SpelReproTests$MapWithConstant).X");
    ...
    public void SPR12803() {
        ...
        SpelExpressionParser parser = new SpelExpressionParser();
        Expression expression = parser.parseExpression("T(io.github.imsejin.expression.spel.SpelReproTests.FooLists).newArrayList(#iterable)");
    ...
    public void SPR12808() {
        SpelExpressionParser parser = new SpelExpressionParser();
        Expression expression = parser.parseExpression("T(io.github.imsejin.expression.spel.SpelReproTests.DistanceEnforcer).from(#no)");
        StandardEvaluationContext sec = new StandardEvaluationContext();
    ...
    public void SPR13055() {
        ...
        String ex = "#root.![T(StringUtils).collectionToCommaDelimitedString(#this.values())]";
    ...
    static class TestPropertyAccessor implements PropertyAccessor {
