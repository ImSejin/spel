...
import io.github.imsejin.expression.spel.ast.CompoundExpression;
import io.github.imsejin.expression.spel.ast.OpLT;
import io.github.imsejin.expression.spel.ast.SpelNodeImpl;
import io.github.imsejin.expression.spel.ast.Ternary;
import io.github.imsejin.expression.spel.standard.SpelCompiler;
...
import io.github.imsejin.expression.spel.testdata.PersonInOtherPackage;
...
public class SpelCompilationCoverageTests extends AbstractExpressionTests {
    ...
    public void constructorReference() throws Exception {
        ...
        String testclass8 = "io.github.imsejin.expression.spel.SpelCompilationCoverageTests$TestClass8";
        ...
        String testclass9 = "io.github.imsejin.expression.spel.SpelCompilationCoverageTests$TestClass9";
...
//		tc.reset();
    ...
    public void compoundExpression() throws Exception {
        ...
        assertThat(expression.getValue(payload).getClass().getName()).isEqualTo("io.github.imsejin.expression.spel.SpelCompilationCoverageTests$Three");
        assertCanCompile(expression);
        assertThat(expression.getValue(payload).getClass().getName()).isEqualTo("io.github.imsejin.expression.spel.SpelCompilationCoverageTests$Three");
        ast = getAst();
        ...
        expression = parser.parseExpression("DR[0]");
        assertThat(expression.getValue(payload).getClass().getName()).isEqualTo("io.github.imsejin.expression.spel.SpelCompilationCoverageTests$Two");
        assertCanCompile(expression);
        assertThat(expression.getValue(payload).getClass().getName()).isEqualTo("io.github.imsejin.expression.spel.SpelCompilationCoverageTests$Two");
