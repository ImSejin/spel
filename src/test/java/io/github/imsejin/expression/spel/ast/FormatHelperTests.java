...
import io.github.imsejin.expression.spel.ast.FormatHelper;
...
public class FormatHelperTests {
	...
	public void formatMethodWithSingleArgumentForMessage() {
		String message = FormatHelper.formatMethodForMessage("foo", Collections.singletonList(TypeDescriptor.forObject("a string")));
