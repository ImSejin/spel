...
import io.github.imsejin.expression.spel.testresources.Inventor;
...
//		teslaContext.setRootObject(tesla);
	...
	public void testConstructors() throws Exception {
		...
		societyContext.setRootObject(new IEEE());
		Inventor einstein =
				parser.parseExpression("new io.github.imsejin.expression.spel.testresources.Inventor('Albert Einstein',new java.util.Date(), 'German')").getValue(Inventor.class);
		assertThat(einstein.getName()).isEqualTo("Albert Einstein");
		//create new inventor instance within add method of List
		parser.parseExpression("Members2.add(new io.github.imsejin.expression.spel.testresources.Inventor('Albert Einstein', 'German'))").getValue(societyContext);
	}
