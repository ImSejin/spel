...
import io.github.imsejin.expression.spel.SpelNode;
import io.github.imsejin.expression.spel.ast.Operator;
...
public class OperatorTests extends AbstractExpressionTests {
	...
	public void testEqual() {
		...
		evaluate("new io.github.imsejin.expression.spel.OperatorTests$SubComparable() == new io.github.imsejin.expression.spel.OperatorTests$OtherSubComparable()", true, Boolean.class);
		...
		evaluate("new io.github.imsejin.expression.spel.OperatorTests$SubComparable() eq new io.github.imsejin.expression.spel.OperatorTests$OtherSubComparable()", true, Boolean.class);
	}
	...
	public void testNotEqual() {
		...
		evaluate("new io.github.imsejin.expression.spel.OperatorTests$SubComparable() != new io.github.imsejin.expression.spel.OperatorTests$OtherSubComparable()", false, Boolean.class);
		...
		evaluate("new io.github.imsejin.expression.spel.OperatorTests$SubComparable() ne new io.github.imsejin.expression.spel.OperatorTests$OtherSubComparable()", false, Boolean.class);
	}
