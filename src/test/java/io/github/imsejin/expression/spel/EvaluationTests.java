...
import io.github.imsejin.expression.spel.testresources.TestPerson;
...
import io.github.imsejin.expression.MethodExecutor;
import io.github.imsejin.expression.MethodFilter;
import io.github.imsejin.expression.MethodResolver;
...
import io.github.imsejin.expression.spel.SpelParseException;
...
public class EvaluationTests extends AbstractExpressionTests {
	...
	public void testPropertyField01() {
		...
		evaluateAndCheckError("madeup", SpelMessage.PROPERTY_OR_FIELD_NOT_READABLE, 0, "madeup",
				"io.github.imsejin.expression.spel.testresources.Inventor");
	}
	...
	public void testTernaryOperator04() {
		...
		Assertions.assertThat(e.isWritable(context)).isFalse();
	}
	...
	public void ctorCallWithRootReferenceThroughParameter() {
		evaluate("new io.github.imsejin.expression.spel.testresources.PlaceOfBirth(inventions[0].toString()).city",
	...
	public void testIndexerError() {
		evaluateAndCheckError("new io.github.imsejin.expression.spel.testresources.Inventor().inventions[1]",
