...
import io.github.imsejin.expression.spel.testresources.PlaceOfBirth;
...
import io.github.imsejin.expression.ConstructorExecutor;
import io.github.imsejin.expression.ConstructorResolver;
...
public class ConstructorInvocationTests extends AbstractExpressionTests {
	...
	public void testConstructorThrowingException_SPR6760() {
		...
		Expression expr = parser.parseExpression("new io.github.imsejin.expression.spel.ConstructorInvocationTests$Tester(#bar).i");
		...
		// 'io.github.imsejin.expression.spel.ConstructorInvocationTests$Tester'
	...
	public void testVarargsInvocation01() {
		...
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit('a','b','c').stringscount()", 3,
			Integer.class);
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit('a').stringscount()", 1, Integer.class);
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit().stringscount()", 0, Integer.class);
		// all need converting to strings
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(1,2,3).stringscount()", 3, Integer.class);
		// needs string conversion
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(1).stringscount()", 1, Integer.class);
		// first and last need conversion
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(1,'a',3.0d).stringscount()", 3,
			Integer.class);
	}
	...
	public void testVarargsInvocation02() {
		...
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(5,'a','b','c').stringscount()", 8,
			Integer.class);
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(2,'a').stringscount()", 3, Integer.class);
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(4).stringscount()", 4, Integer.class);
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(8,2,3).stringscount()", 10, Integer.class);
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(9).stringscount()", 9, Integer.class);
		evaluate("new io.github.imsejin.expression.spel.testresources.Fruit(2,'a',3.0d).stringscount()", 4,
			Integer.class);
		evaluate(
			"new io.github.imsejin.expression.spel.testresources.Fruit(8,stringArrayOfThreeItems).stringscount()",
			11, Integer.class);
	}
