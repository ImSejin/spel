...
public class IndexingTests {
	...
	public void indexIntoGenericPropertyContainingMap() {
		...
		assertThat(expression.getValueTypeDescriptor(this).toString()).isEqualTo("@io.github.imsejin.expression.spel.IndexingTests$FieldAnnotation java.util.HashMap<?, ?>");
	...
	public void indexIntoGenericPropertyContainingList() {
		...
		SpelExpressionParser parser = new SpelExpressionParser();
		Expression expression = parser.parseExpression("property");
		assertThat(expression.getValueTypeDescriptor(this).toString()).isEqualTo("@io.github.imsejin.expression.spel.IndexingTests$FieldAnnotation java.util.ArrayList<?>");
		assertThat(expression.getValue(this)).isEqualTo(property);
	...
	public void indexIntoGenericPropertyContainingNullList() {
		...
		Expression expression = parser.parseExpression("property");
		assertThat(expression.getValueTypeDescriptor(this).toString()).isEqualTo("@io.github.imsejin.expression.spel.IndexingTests$FieldAnnotation java.lang.Object");
		assertThat(expression.getValue(this)).isEqualTo(property);
		expression = parser.parseExpression("property[0]");
		try {
			assertThat(expression.getValue(this)).isEqualTo("bar");
	...
	public void indexIntoGenericPropertyContainingArray() {
		...
		SpelExpressionParser parser = new SpelExpressionParser();
		Expression expression = parser.parseExpression("property");
		assertThat(expression.getValueTypeDescriptor(this).toString()).isEqualTo("@io.github.imsejin.expression.spel.IndexingTests$FieldAnnotation java.lang.String[]");
		assertThat(expression.getValue(this)).isEqualTo(property);
		expression = parser.parseExpression("property[0]");
		assertThat(expression.getValue(this)).isEqualTo("bar");
	}
	...
	public void resolveCollectionElementTypeNull() {
		SpelExpressionParser parser = new SpelExpressionParser();
		Expression expression = parser.parseExpression("listNotGeneric");
		assertThat(expression.getValueTypeDescriptor(this).toString()).isEqualTo("@io.github.imsejin.expression.spel.IndexingTests$FieldAnnotation java.util.List<?>");
	}
